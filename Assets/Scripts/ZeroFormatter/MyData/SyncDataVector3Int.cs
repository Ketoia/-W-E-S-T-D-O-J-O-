...
namespace MyData
{
    ...
    public class SyncDataVector3IntFormatter<TTypeResolver> : Formatter<TTypeResolver, global::MyData.SyncDataVector3Int>
        where TTypeResolver : ITypeResolver, new()
    {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::MyData.SyncDataVector3Int value)
        {
            ...
            else
            {
                ...
                offset += ObjectSegmentHelper.SerializeFromFormatter<TTypeResolver, global::MyData.Vector3Int>(ref bytes, startOffset, offset, 2, value.Value);

                return ObjectSegmentHelper.WriteSize(ref bytes, startOffset, offset, 2);
            }
        }

        public override global::MyData.SyncDataVector3Int Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            ...
            return new SyncDataVector3IntObjectSegment<TTypeResolver>(tracker, new ArraySegment<byte>(bytes, offset, byteSize));
        }
    }

    public class SyncDataVector3IntObjectSegment<TTypeResolver> : global::MyData.SyncDataVector3Int, IZeroFormatterSegment
        where TTypeResolver : ITypeResolver, new()
    {
        ...
        CacheSegment<TTypeResolver, global::MyData.Vector3Int> _Value;
        ...
        // 2
        public override global::MyData.Vector3Int Value
        {
            get
            {
                return _Value.Value;
        ...
        public SyncDataVector3IntObjectSegment(global::ZeroFormatter.DirtyTracker dirtyTracker, ArraySegment<byte> originalBytes)
        {
            ...
            _Value = new CacheSegment<TTypeResolver, global::MyData.Vector3Int>(__tracker, ObjectSegmentHelper.GetSegment(originalBytes, 2, __binaryLastIndex, __tracker));
        }
        ...
        public int Serialize(ref byte[] targetBytes, int offset)
        {
            if (__extraFixedBytes != null || __tracker.IsDirty)
            {
                ...
                offset += ObjectSegmentHelper.SerializeCacheSegment<TTypeResolver, global::MyData.Vector3Int>(ref targetBytes, startOffset, offset, 2, ref _Value);
