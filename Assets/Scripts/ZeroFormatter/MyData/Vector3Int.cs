...
namespace MyData
{
    ...
    public class Vector3IntFormatter<TTypeResolver> : Formatter<TTypeResolver, global::MyData.Vector3Int>
        where TTypeResolver : ITypeResolver, new()
    {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::MyData.Vector3Int value)
        {
        ...
        public override global::MyData.Vector3Int Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            byteSize = 0;
            int size;
            ...
            return new global::MyData.Vector3Int(item0, item1, item2);
        }
    }
