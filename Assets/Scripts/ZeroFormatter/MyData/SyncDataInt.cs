...
namespace MyData
{
    ...
    public class SyncDataIntFormatter<TTypeResolver> : Formatter<TTypeResolver, global::MyData.SyncDataInt>
        where TTypeResolver : ITypeResolver, new()
    {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::MyData.SyncDataInt value)
        {
            ...
            else
            {
                ...
                offset += ObjectSegmentHelper.SerializeFromFormatter<TTypeResolver, int>(ref bytes, startOffset, offset, 2, value.Value);

                return ObjectSegmentHelper.WriteSize(ref bytes, startOffset, offset, 2);
            }
        }

        public override global::MyData.SyncDataInt Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            ...
            return new SyncDataIntObjectSegment<TTypeResolver>(tracker, new ArraySegment<byte>(bytes, offset, byteSize));
        }
    }

    public class SyncDataIntObjectSegment<TTypeResolver> : global::MyData.SyncDataInt, IZeroFormatterSegment
        where TTypeResolver : ITypeResolver, new()
    {
        ...
        public SyncDataIntObjectSegment(global::ZeroFormatter.DirtyTracker dirtyTracker, ArraySegment<byte> originalBytes)
        {
