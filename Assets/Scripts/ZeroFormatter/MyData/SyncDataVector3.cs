...
namespace MyData
{
    ...
    public class SyncDataVector3Formatter<TTypeResolver> : Formatter<TTypeResolver, global::MyData.SyncDataVector3>
        where TTypeResolver : ITypeResolver, new()
    {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::MyData.SyncDataVector3 value)
        {
            ...
            else
            {
                ...
                offset += ObjectSegmentHelper.SerializeFromFormatter<TTypeResolver, global::MyData.Vector3>(ref bytes, startOffset, offset, 2, value.Value);

                return ObjectSegmentHelper.WriteSize(ref bytes, startOffset, offset, 2);
            }
        }

        public override global::MyData.SyncDataVector3 Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            ...
            return new SyncDataVector3ObjectSegment<TTypeResolver>(tracker, new ArraySegment<byte>(bytes, offset, byteSize));
        }
    }

    public class SyncDataVector3ObjectSegment<TTypeResolver> : global::MyData.SyncDataVector3, IZeroFormatterSegment
        where TTypeResolver : ITypeResolver, new()
    {
        ...
        CacheSegment<TTypeResolver, global::MyData.Vector3> _Value;
        ...
        // 2
        public override global::MyData.Vector3 Value
        {
            get
            {
                return _Value.Value;
        ...
        public SyncDataVector3ObjectSegment(global::ZeroFormatter.DirtyTracker dirtyTracker, ArraySegment<byte> originalBytes)
        {
            ...
            _Value = new CacheSegment<TTypeResolver, global::MyData.Vector3>(__tracker, ObjectSegmentHelper.GetSegment(originalBytes, 2, __binaryLastIndex, __tracker));
        }
        ...
        public int Serialize(ref byte[] targetBytes, int offset)
        {
            if (__extraFixedBytes != null || __tracker.IsDirty)
            {
                ...
                offset += ObjectSegmentHelper.SerializeCacheSegment<TTypeResolver, global::MyData.Vector3>(ref targetBytes, startOffset, offset, 2, ref _Value);
