...
namespace MyData
{
    ...
    public class SyncDataStringFormatter<TTypeResolver> : Formatter<TTypeResolver, global::MyData.SyncDataString>
        where TTypeResolver : ITypeResolver, new()
    {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::MyData.SyncDataString value)
        {
        ...
        public override global::MyData.SyncDataString Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            ...
            return new SyncDataStringObjectSegment<TTypeResolver>(tracker, new ArraySegment<byte>(bytes, offset, byteSize));
        }
    }

    public class SyncDataStringObjectSegment<TTypeResolver> : global::MyData.SyncDataString, IZeroFormatterSegment
        where TTypeResolver : ITypeResolver, new()
    {
        ...
        public SyncDataStringObjectSegment(global::ZeroFormatter.DirtyTracker dirtyTracker, ArraySegment<byte> originalBytes)
        {
